...
export function DownIcon() {
  ...
  const bounceAnimation = {
    ...
    transition: {
      ...
      repeatType: "loop" as const, // How the animation repeats
    },
  }
  ...
  return (
    <motion.div
      className="down-icon"
      style={{ display: "inline-block" }} // Ensures the div behaves like the svg
      initial={arrowFadeInAnimation.initial} // Initial state for the fade-in animation
      animate={bounceAnimation} // Applies the bounce animation
...
export function ReactIcon() {
  return (
    <>
      <svg viewBox="0 0 24 24" fill="black" className="react-icon">
